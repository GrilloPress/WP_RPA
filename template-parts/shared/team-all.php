        ...
        <div class="row">
          ...
          <section id="giles-morrison" class="card-team-member card-full col-md-3 col-sm-3">       
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <h4>Mr Giles Morrison</h4>
                <p>Head of Radiation Protection Services, RPA, Diagnostic Radiology/Laser Protection and UV</p>
                <p>Head of Section for 10 Years. 25 years experience of delivering Radiation Protection in healthcare.</p>
                <p>Deputy Regional Physics QA Chair for the Screening QA Service (North) for Mammography</p>
                <p>Represents the IPEM Radiation Protection Special Interest Group as Lead Medical Physics Expert on the Health Research Authority Guardians on Medical Research Exposures.</p>
              </div>
            </div>
          </section>
          ...
          <section id="mark-singleton" class="card-team-member card-full col-md-3 col-sm-3">       
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <h4>Mr Mark Singleton</h4>
                <p>Deputy Head of Radiation Protection Services, RPA,  Radioactive Substances, Accredited Radioactive Waste Adviser </p>
                <p>Radiation Protection Clinical Scientist since September 1998 </p>
                <p>Assessor for RPA 2000, accredited by the HSE to undertake assessment of RPA certification applications</p>
                <p>Section Lead for the Modernising Scientific Careers Scientific Training Program</p>
              </div>
            </div>
          </section>
        ...
        <div class="row">
          ...
          <section id="matt-hill" class="card-team-member card-full col-md-3 col-sm-3">       
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <h4>Mr Matt Hill</h4>
                <p>Registered Clinical Scientist: Medical Physics Expert, specialising in Mammography</p>
              </div>
            </div>
          </section>
          ...
          <section id="paul-harris" class="card-team-member card-full col-md-3 col-sm-3">       
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <h4>Dr Paul Harris</h4>
                <p>Registered Clinical Scientist: Lead for Radon environmental management and metrology</p>
              </div>
            </div>
          </section>
          ...
          <section id="chris-ogley" class="card-team-member card-full col-md-3 col-sm-3">       
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <h4>Mr Chris Ogley</h4>
                <p>Registered Clinical Technologist: Chief Clinical Technologist for Radiation Protection Assurance</p>
                <p>Technical Lead in delivering Diagnostic Radiology QA services and supervision of Unsealed Technical QA with 14 years’ experience in Radiation Protection Section</p>
                <p>IPEM Diagnostic and Unsealed Radiation Protection Trainee Technologist Supervisor</p>
              </div>
            </div>
          </section>
        ...
        <div class="row">
          ...
          <section id="mike-tyas" class="card-team-member card-full col-md-3 col-sm-3">       
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <h4>Mr Mike Tyas</h4>
                <p>Registered Clinical Technologist: Senior Clinical Technologist for Radiation Protection Assurance</p>
              </div>
            </div>
          </section>
          ...
          <section id="emily-perry" class="card-team-member card-full col-md-3 col-sm-3">       
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <h4>Miss Emily Perry</h4>
                <p>Clinical Technologist</p>
              </div>
            </div>
          </section>
          ...
          <section id="andy-fry" class="card-team-member card-full col-md-3 col-sm-3">       
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <h4>Mr Andy Fry</h4>
                <p>Trainee Clinical Scientist, MR</p>
              </div>
            </div>
          </section>
